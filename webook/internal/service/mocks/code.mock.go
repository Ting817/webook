...
func (m *MockCodeService) Send(c context.Context, biz, phone string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Send", c, biz, phone)
	ret0, _ := ret[0].(error)
	return ret0
}

// Send indicates an expected call of Send.
func (mr *MockCodeServiceMockRecorder) Send(c, biz, phone any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Send", reflect.TypeOf((*MockCodeService)(nil).Send), c, biz, phone)
}

// Verify mocks base method.
func (m *MockCodeService) Verify(c context.Context, biz, phone, inputCode string) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCodeServiceMockRecorder) Verify(c, biz, phone, inputCode any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Verify", reflect.TypeOf((*MockCodeService)(nil).Verify), c, biz, phone, inputCode)
}
